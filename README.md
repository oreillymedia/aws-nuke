...
`$ wget -c https://github.com/rebuy-de/aws-nuke/releases/download/2.23.0-orm.1/aws-nuke-2.23.0-orm.1-linux-amd64.tar.gz -O - | tar -xz -C $HOME/bin`

Run
`$ aws-nuke-2.23.0-orm.1-linux-amd64`
...
$ docker run \
    ...
    quay.io/rebuy/aws-nuke:2.23.0-orm.1 \
    --profile default \
